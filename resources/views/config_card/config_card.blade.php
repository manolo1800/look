    ...
    <div class="main-container container">
        <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-12 col-xl-12">
                <form name="form" method="post" class="form-horizontal" action="{{route('config_card.store')}}" enctype="multipart/form-data">
                    {{ csrf_field() }}
                    ...
                    <div id="formulario_registro">
                        ...
                        <div class='col-xs-8 col-sm-8 col-md-8 col-xl-8 col-xs-offset-1 col-md-offset-1 col-sm-offset-1'>
                            ...
                            <div class="form-group col-xs-12">
                                ...
                                <div class=''>
                                    <div class='col-xs-6'>
                                        <input type="text" id="nombre_tarjeta" name="nombre_tarjeta"  placeholder="nombre de la tarjeta" class="form-control tip" maxlength="9" title="Ingresa el nombre de la tarjeta" />
                            ...
                            <div class="form-group col-xs-12">
                                ...
                                <div class=''>
                                    <div class='col-xs-6'>
                                        <input type="text" id="tipo_target" name="tipo_target"  placeholder="Tipo de tarjeta" class="form-control tip" maxlength="9" title="Ingresa el nombre de la tarjeta" />
                            ...
                            <div class="form-group col-xs-12">
                                ...
                                <div class=''>
                                    <div class='col-xs-6'>
                                        ...
                                        <option value="{{$port->puerto}}">{{$port->puerto}}</option> ;
                                        @endforeach
                                        </select>
                            ...
                            <div class="form-group  pull-right">
                                <button type="" class="btn btn-primary" onClick="">Crear</button>
                                <a href="{{ url('config_cards') }}">
                                    <button type="button" class="btn btn-primary" onClick="">Mostrar Todos</button>
                                </a>
                                <!-- <button onClick="mostrar()" type="button" class="btn btn-primary" >Mostrar Todos</button> -->
