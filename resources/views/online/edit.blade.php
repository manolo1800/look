    ...
    <div class="main-container container">
        <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-12 col-xl-12">
                <form name="form" method="post" class="form-horizontal" action="{{url('/online/'.$online_Profile->id)}}" enctype="multipart/form-data">
                    {{ csrf_field() }}
                    {{ method_field('PATCH')}}
                    <div id="formulario_registro">
                        ...
                        <div class='col-xs-8 col-sm-8 col-md-8 col-xl-8 col-xs-offset-1 col-md-offset-1 col-sm-offset-1'>
                            ...
                            <div class="form-group col-xs-12">
                                ...
                                <div class=''>
                                    <div class='col-xs-6'>
                                        <input type="text" id="id" name="id" placeholder="xxxx" value="{{ $online_Profile->id}}" class="form-control tip" maxlength="9" title="Ingresa el número sin puntos" />
                            ...
                            <div class="form-group col-xs-12">
                                ...
                                <div class=''>
                                    <div class='col-xs-6'>
                                        <input type="text" id="name_online" name="name_online" placeholder="Nombre del Perfil de linea" value="{{ $online_Profile->name_online}}" class="form-control tip" maxlength="9" title="Ingresa el número sin puntos" />
                                ...
                                <div class=''>
                                    <div class='col-xs-6'>
                                        <select id="tipo_producto" name="tipo_producto" class="form-control required">
                                            <option value="{{$productactu->id}}">{{$productactu->name_product}}</option>
                                ...
                                <div class=''>
                                    <div class='col-xs-6'>
                                        <select id="ont_usuarios_id" name="ont_usuarios_id" class="form-control required">
                                            <option value="{{$ont_tipo_srvactu->id}}">{{$ont_tipo_srvactu->tipos_user}}</option>
                            ...
                            <div class="form-group col-xs-12">
                                ...
                                <div class=''>
                                    <div class='col-xs-6'>
                                        <input type="text" id="Stream_up" name="Stream_up" value="{{ $online_Profile->Stream_up}}" placeholder="xxxx" class="form-control tip" maxlength="4" title="Ingresa el número sin puntos" />
                            ...
                            <div class="form-group col-xs-12">
                                ...
                                <div class=''>
                                    <div class='col-xs-6'>
                                        <input type="text" id="Stream_down" name="Stream_down" value="{{ $online_Profile->Stream_down}}" placeholder="xxxx" class="form-control tip" maxlength="4" title="Ingresa el número sin puntos" />
                                        {!!$errors->first('Stream_down','<span class="alert-danger fade in">:message</span>')!!}
                                    </div>
                                </div>
                            </div>
                            <div class="form-group col-xs-12">
                                <label class="control-label col-xs-6 required" for="form_cedula">Estado del perfil <label class="rojo">*</label></label>
                                <div class=''>
                                    <div class='col-xs-6'>
