                    ...
                    <div id="formulario_registro">
                        ...
                        <div class='col-xs-8 col-sm-8 col-md-8 col-xl-8 col-xs-offset-1 col-md-offset-1 col-sm-offset-1'>
                            ...
                            <div class="form-group col-xs-12">
                                ...
                                <div class=''>
                                    <div class='col-xs-6'>
                                        <input type="text" id="name_product" name="name_product" required="required" placeholder="Nombre del Producto" class="form-control tip" maxlength="9" title="Ingresa el número sin puntos" />
                            ...
                            <div class="form-group col-xs-12">
                                ...
                                <div class=''>
                                    <div class='col-xs-6'>
                                        <select id="status" name="status" required="required" class="form-control required">
                                            <option value="">-</option>
                            ...
                            <div class="form-group col-xs-12">
                                ...
                                <div class='col-xs-2'>
                                    <select id="firstlist" name="select1[]" class="form-control" multiple="multiple">
                                        @foreach($planes as $plan)
                                            <option>{{$plan->Nombre_plan}}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class='col-xs-2'>
                                ...
                                <!-- </div> -->
                                <div class='col-xs-2'>
                                    <select id="secondlist" name="select2[]" required="required"  class="form-control" multiple="multiple">
                                    </select>
                                </div>
                            </div>
