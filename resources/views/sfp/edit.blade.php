                    ...
                    <div id="formulario_registro">
                        ...
                        <div class='col-xs-8 col-sm-8 col-md-8 col-xl-8 col-xs-offset-1 col-md-offset-1 col-sm-offset-1'>
                            ...
                            <div class="form-group col-xs-12">
                                ...
                                <div class=''>
                                    <div class='col-xs-6'>
                                        <input type="text" id="nameSfp" name="nameSfp" value="{{$sfp->nameSfp}}" class="form-control tip" maxlength="3" title="Ingresa el número sin puntos" />
                            ...
                            <div class="form-group col-xs-12">
                                ...
                                <div class=''>
                                    <div class='col-xs-6'>
                                        <input type="text" id="Stream_up" name="Stream_up" value="{{$sfp->Stream_up}}" class="form-control tip" maxlength="4" title="Ingresa el número sin puntos" />
                            ...
                            <div class="form-group col-xs-12">
                                ...
                                <div class=''>
                                    <div class='col-xs-6'>
                                        <input type="text" id="Stream_down" name="Stream_down" value="{{$sfp->Stream_down}}" class="form-control tip" maxlength="4" title="Ingresa el número sin puntos" />
