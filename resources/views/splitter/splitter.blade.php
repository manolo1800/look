                    ...
                    <div id="formulario_registro">
                        ...
                        <div class='col-xs-8 col-sm-8 col-md-8 col-xl-8 col-xs-offset-1 col-md-offset-1 col-sm-offset-1'>
                            ...
                            <div class="form-group col-xs-12">
                                ...
                                <div class=''>
                                    <div class='col-xs-6'>
                                        <input type="text" id="nivel"  name="nivelDivision" readonly placeholder="Nivel de división" class="form-control tip" maxlength="25"  title="Ingresa el nÃºmero sin puntos" />
                            ...
                            <div class="form-group col-xs-12">
                                ...
                                <div class=''>
                                    <div class='col-xs-6'>
                                        <input type="text" id="perdida"  name="perdida" placeholder=" Pérdida" class="form-control tip" maxlength="50"  title="Ingresa el nÃºmero sin puntos" />
                            ...
                            <div class="form-group col-xs-12">
                                ...
                                <div class=''>
                                    <div class='col-xs-6'>
                                        <input type="text" id="latitud1"  name="latitud1" placeholder=" Latitud" class="form-control tip" maxlength="50"  title="Ingresa el nÃºmero sin puntos" />
                            ...
                            <div class="form-group col-xs-12">
                                ...
                                <div class=''>
                                    <div class='col-xs-6'>
                                        <input type="text" id="longitud1"  name="longitud1" placeholder="el valor debe ser negativo ej.: -1234" class="form-control tip" maxlength="50"  title="Ingresa el nÃºmero sin puntos" />
