    ...
    <div class="main-container container">
        <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-12 col-xl-12">
                <form name="form" method="post" class="form-horizontal" action="{{url('/traffic_config')}}" enctype="multipart/form-data">
                    {{ csrf_field() }}
                    ...
                    <div id="formulario_registro">
                        ...
                        <div class='col-xs-8 col-sm-8 col-md-8 col-xl-8 col-xs-offset-1 col-md-offset-1 col-sm-offset-1'>
                            ...
                            <div class="form-group col-xs-12">
                                ...
                                <div class=''>
                                    <div class='col-xs-6'>
                                        <input type="text" id="nombre" name="nombre" required="required" placeholder="nombre" class="form-control tip" maxlength="9" title="Ingresa el nombre" />
                            ...
                            <div class="form-group col-xs-12">
                                ...
                                <div class=''>
                                    <div class='col-xs-6'>
                                        <input type="number" id="cir" name="cir" required="required" placeholder="cir" class="form-control tip" maxlength="9" title="ingrese un numero sin puntos" />
                            ...
                            <div class="form-group col-xs-12">
                                ...
                                <div class=''>
                                    <div class='col-xs-6'>
                                        <input type="number" id="pir" name="pir" required="required" placeholder="pir" class="form-control tip" maxlength="9" title="ingrese un numero sin puntos" />
